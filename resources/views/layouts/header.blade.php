<nav class="bg-sky-400 border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-sky-800 z-50 shadow-md">
    <div class="container flex flex-wrap justify-between items-center mx-auto">
        <div class="p-2 ml-3 text-gray-500" data-collapse-toggle="sidebar" aria-controls="sidebar" aria-expanded="false">
